...
set project_name            "zynqmp_acp_adapter_read_test"
set board_part              [get_board_parts -quiet -latest_file_version "*ultra96v1*"]
set device_parts            "xczu3eg-sbva484-1-e"
set test_bench              "ZYNQMP_ACP_ADAPTER_READ_TEST"
set scenario_file           [file join $project_directory ".." ".." ".." "src" "test" "scenarios" "zynqmp_acp_adapter_read_test.snr" ]
#
# Create project
#
